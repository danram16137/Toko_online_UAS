                        ...
                        <div class="card-body">
                            <div class="cart-checkout">
                                ...
                                <div class="info-3 pt-3">
                                    <a href="{{ route('checkout.index') }}"><button class="button-primary w-100">PEMBAYARAN</button></a>
                                </div>
    ...
    <div class="container p-0 ">
        <div class="row">
            <div class="col-12 d-flex flex-column justify-content-center align-items-center empty-cart">
                ...
                <div><h4><b>Keranjangmu kosong.</b></h4></div>
                <div><a href="{{ route('product.index') }}">Beli sepatu dulu :)</a></div>
            </div>
        </div>
    </div>
